...
direct_register_custom_op(
    ...
    # The wait does not write the output buffer. Marking it as mutated causes
    # Inductor to auto-functionalize a persistent module buffer during graph
    # capture, which cannot be lowered on the SM75 compile path. The current
    # hidden states are the true ordering dependency, matching vLLM's prefetch
    # offloader synchronization convention.
