...
if TYPE_CHECKING:
    ...
    VLLM_TURBOQUANT_CONTINUATION_PREFIX_COMBINE: Literal["off", "on", "auto"] = "off"
    ...
    VLLM_TURBOQUANT_DECODE_BLOCK_KV: int = 4
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    "VLLM_TURBOQUANT_CONTINUATION_PREFIX_COMBINE": lambda: os.getenv(
        "VLLM_TURBOQUANT_CONTINUATION_PREFIX_COMBINE", "off"
    )
    .strip()
    .lower(),
    ...
    "VLLM_TURBOQUANT_DECODE_BLOCK_KV": lambda: int(
        os.getenv("VLLM_TURBOQUANT_DECODE_BLOCK_KV", "4")
    ),
