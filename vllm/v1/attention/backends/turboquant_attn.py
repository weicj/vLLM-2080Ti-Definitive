...
_TQ_CONTINUATION_PREFIX_COMBINE_MIN_TOKENS = max(
    0,
    int(
        os.getenv("VLLM_TURBOQUANT_CONTINUATION_PREFIX_COMBINE_MIN_TOKENS")
        or "20480"
    ),
)
...
_SM75_TQ_FI_PREFILL_MIN_HEAD_DIM = int(
    os.getenv("VLLM_TURBOQUANT_SM75_FLASHINFER_PREFILL_MIN_HEAD_DIM")
    or _SM75_TQ_FI_PREFILL_MIN_HEAD_DIM_DEFAULT
)
_SM75_TQ_FI_PREFILL_MIN_QUERY_LEN = int(
    os.getenv("VLLM_TURBOQUANT_SM75_FLASHINFER_PREFILL_MIN_QUERY_LEN")
    or _SM75_TQ_FI_PREFILL_MIN_QUERY_LEN_DEFAULT
)
_SM75_TQ_FI_CONTINUATION_MIN_QUERY_LEN = int(
    os.getenv("VLLM_TURBOQUANT_SM75_FLASHINFER_CONTINUATION_MIN_QUERY_LEN")
    or _SM75_TQ_FI_CONTINUATION_MIN_QUERY_LEN_DEFAULT
)
...
_TQ_FI_PREFILL_PLAN_CACHE_MAXSIZE = max(
    1,
    int(
        os.getenv("VLLM_TURBOQUANT_FLASHINFER_PREFILL_PLAN_CACHE_MAXSIZE")
        or "16"
    ),
)
