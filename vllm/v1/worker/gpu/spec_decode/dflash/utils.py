...
def load_dflash_model(target_model: nn.Module, vllm_config: VllmConfig) -> nn.Module:
    ...
    draft_vllm_config = replace(
        ...
        # This runtime line has one KV-cache configuration shared by target
        # and draft. Newer vLLM exposes a separate draft KV dtype; retaining
        # the target cache here is the only valid behavior on this branch.
