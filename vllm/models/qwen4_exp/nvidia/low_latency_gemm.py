...
QWEN4_EXP_GEMM_PLANS: dict[tuple[int, int], dict[int, SkinnyGemmConfig]] = {
    ...
    (336, 10240): {
        # ``static_k`` was removed from the local SkinnyGemmConfig API. The
        # Qwen4Exp fast path is gated to SM103, so the same shape plan is
        # valid without that optional hint on older vLLM bases.
        1: SkinnyGemmConfig(1, 128, 1),
        2: SkinnyGemmConfig(2, 128, 1),
        4: SkinnyGemmConfig(4, 128, 2),
