...
class QSAIndexer(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        # The checkpoint defaults to BF16, but SM75 deployments may run the
        # model in FP16. Keep side caches in the runtime dtype so CUDA graph
        # capture never receives BF16 QSA cache tensors.
        qsa_cache_dtype = vllm_config.model_config.dtype
